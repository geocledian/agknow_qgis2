...
from qgis.core import QgsGeometry, QgsFeature, QgsCoordinateReferenceSystem, QgsCoordinateTransform, QgsRasterLayer, QgsMapLayerRegistry, QgsProject
...
class AgknowUtils(object):
    ...
    def sync_http_get(self, base_url, params="", ssl_verify=True, return_raw=False):
        ...
        try:
            # timeout 10 seconds
            resp = requests.get(url, verify=ssl_verify, timeout=10.0)
