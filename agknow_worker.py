...
class Worker(QtCore.QObject):
    ...
    def http_get(self):
        ...
        try:
            # timeout 5 seconds
            resp = requests.get(url, verify=self.ssl_verify, timeout=5.0)
    ...
    def get_images(self):
        ...
        try:
            QgsMessageLog.logMessage("AgknowWorker - Downloading images..", "agknow", QgsMessageLog.INFO)
            ...
            for parcel_id in self.parcel_ids:
                ...
                for r in rasters:
                    ...
                    # maybe image is corrupt or the scene has not the required bands for the index
                        ...
                        QgsMessageLog.logMessage("AgknowWorker - Download of image {0} failed!".format(raster_id), "agknow", QgsMessageLog.WARNING)
                        QgsMessageLog.logMessage("AgknowWorker\n - {0}".format(e.message), "agknow", QgsMessageLog.WARNING)
